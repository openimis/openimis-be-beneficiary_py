...
class BeneficiaryServiceTest(TestCase):
    ...
    def add_beneficiary_return_result(self, individual: Individual, benefit_plan: BenefitPlan = None,
                                      status="POTENTIAL"):
    ...
    def test_add_beneficiary(self):
        ...
        self.check_active_beneficiaries_count_eq(1, self.benefit_plan,
        ...
        for i, individual in enumerate([self.individual, self.individual2]):
            ...
            self.check_beneficiary_exists(uuid, with_status="ACTIVE")
            self.check_active_beneficiaries_count_eq(i + 1, self.benefit_plan_no_max,
