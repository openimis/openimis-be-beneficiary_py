...
from beneficiary.tests.test_helpers import create_benefit_plan
from beneficiary.workflows.base_beneficiary_upload import process_import_beneficiaries_workflow
...
class ProcessImportBeneficiariesWorkflowTest(TestCase):
    ...
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_beneficiary_upload', False)
    ...
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_beneficiary_upload', True)
    ...
    @patch('individual.apps.IndividualConfig.enable_maker_checker_for_individual_upload', False)
    @patch('individual.apps.IndividualConfig.enable_maker_checker_for_group_upload', False)
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_group_upload', False)
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_beneficiary_upload', False)
    @patch('beneficiary.apps.SocialProtectionConfig.validation_import_group_valid_items',
           "validation.import_group_valid_items")
    @patch('beneficiary.apps.SocialProtectionConfig.validation_import_valid_items_workflow',
    ...
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_group_upload', True)
    @patch('beneficiary.apps.SocialProtectionConfig.enable_maker_checker_for_beneficiary_upload', True)
    @patch('beneficiary.apps.SocialProtectionConfig.validation_import_group_valid_items',
           "validation.import_group_valid_items")
    @patch('beneficiary.apps.SocialProtectionConfig.validation_import_valid_items_workflow',
