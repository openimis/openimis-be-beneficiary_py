...
from beneficiary.utils import calculate_percentage_of_invalid_items
...
def on_confirm_enrollment_of_group(**kwargs):
    ...
    if BeneficiaryConfig.enable_maker_checker_logic_enrollment:
        ...
        TaskService(user).create({
            ...
            'business_event': BeneficiaryConfig.validation_group_enrollment,
            'json_ext': json_ext
        })
    else:
