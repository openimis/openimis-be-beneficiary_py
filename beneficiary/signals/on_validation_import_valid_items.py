...
class BaseGroupColumnAggregationClass(ItemsUploadTaskCompletionEvent):
    ...
    def _create_task(self):
        ...
        TaskService(self.user).create({
            ...
            'business_event': BeneficiaryConfig.validation_import_group_valid_items,
            'json_ext': json_ext
        })
    ...
    def _create_task_or_data_source_into_entity(self):
        if BeneficiaryConfig.enable_maker_checker_for_group_upload:
            self._create_task()
        else:
...
def on_task_complete_action(business_event, **kwargs):
    ...
    try:
        ...
        if business_event == BeneficiaryConfig.validation_import_valid_items:
            workflow = BeneficiaryConfig.validation_import_valid_items_workflow
        ...
        elif business_event == BeneficiaryConfig.validation_upload_valid_items:
            workflow = BeneficiaryConfig.validation_upload_valid_items_workflow
        ...
        elif business_event == BeneficiaryConfig.validation_enrollment:
            ...
            return
        elif business_event == BeneficiaryConfig.validation_group_enrollment:
            ...
            try:
                ...
                logger.error(f"Validation error occurred: {e}")
            return
        elif business_event == BeneficiaryConfig.validation_import_group_valid_items:
...
def on_task_complete_import_validated(**kwargs):
    from beneficiary.apps import BeneficiaryConfig
    on_task_complete_action(BeneficiaryConfig.validation_import_valid_items, **kwargs)
    on_task_complete_action(BeneficiaryConfig.validation_upload_valid_items, **kwargs)
    on_task_complete_action(BeneficiaryConfig.validation_enrollment, **kwargs)
    on_task_complete_action(BeneficiaryConfig.validation_group_enrollment, **kwargs)
    on_task_complete_action(BeneficiaryConfig.validation_import_group_valid_items, **kwargs)
...
def _complete_task_for_accepted(_task, accept, user):
    ...
    if _task.business_event == BeneficiaryConfig.validation_import_valid_items:
        IndividualItemsImportTaskCompletionEvent(
    ...
    if _task.business_event == BeneficiaryConfig.validation_upload_valid_items:
        IndividualItemsUploadTaskCompletionEvent(
    ...
    if _task.business_event == BeneficiaryConfig.validation_import_group_valid_items:
        BaseGroupColumnAggregationClass.group_data_sources_into_entities(
    ...
    try:
        ...
        if result and result['success'] \
                ...
                and result['data']['task']['business_event'] in [
                    BeneficiaryConfig.validation_import_valid_items,
                    BeneficiaryConfig.validation_upload_valid_items,
                    BeneficiaryConfig.validation_import_group_valid_items,
                ]:
